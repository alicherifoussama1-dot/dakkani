...
import { Card, Chips, Loading, ErrorState } from '../src/components/ui'
import TopBar from '../src/components/TopBar'
import { IconBack, IconLocation } from '../src/components/Icons'
import { color, font, radius, shadow, fmtDZD, fmtNum , fontFamily } from '../src/theme/tokens'
...
export default function MapScreen() {
  ...
  return (
    <View style={styles.root}>
      <TopBar title="الخريطة" onBack={() => router.back()} />
...
const styles = StyleSheet.create({
  ...
  selAr: { fontSize: 16, fontFamily: fontFamily.bold, color: color.ink },
  selFr: { fontSize: 11.5, fontFamily: fontFamily.semibold, color: color.ink3, marginTop: 2 },
  selCode: { fontSize: 13, fontFamily: fontFamily.bold, color: color.br700, fontVariant: ['tabular-nums'] },
  ...
  selStatValue: { fontSize: 14, fontFamily: fontFamily.bold, color: color.br700, fontVariant: ['tabular-nums'] },
  selStatLabel: { fontSize: 10, fontFamily: fontFamily.bold, color: color.ink3, marginTop: 3 },
  estimate: { fontSize: 10.5, fontFamily: fontFamily.semibold, color: color.ink3, marginTop: 9, lineHeight: 16 },
  rankRow: { flexDirection: 'row', alignItems: 'center', gap: 11 },
  rank: {
    width: 26, textAlign: 'center', fontSize: 12, fontFamily: fontFamily.bold, color: color.ink3,
    fontVariant: ['tabular-nums'],
  },
  rankName: { fontSize: 13, fontFamily: fontFamily.bold, color: color.ink },
  rankFr: { fontSize: 10.5, fontFamily: fontFamily.semibold, color: color.ink3, marginTop: 2 },
  rankCount: { fontSize: 15, fontFamily: fontFamily.bold, color: color.br700, fontVariant: ['tabular-nums'] },
})
