...
import { GlassCard, Loading, ErrorState, Button } from '../../src/components/ui'
...
function NotificationSettings() {
  ...
  return (
    <>
      ...
      <GlassCard index={2} style={{ marginTop: 16 }}>
...
function LanguageSettings() {
  ...
  return (
    <>
      ...
      <GlassCard index={0} style={{ padding: 0 }}>
        {LANGS.map((l, i) => (
...
const styles = StyleSheet.create({
  ...
  rowTitle: { fontSize: 13.5, fontWeight: '800', color: color.ink },
  hint: { fontSize: 11, fontWeight: '600', color: color.ink3, marginTop: 3, lineHeight: 18 },
  toggleRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 6 },
  divider: { height: 1, backgroundColor: color.hairline, marginVertical: 8 },
