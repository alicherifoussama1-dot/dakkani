...
import { color, radius, shadow, font, motion, fmtDZD, fmtNum } from '../theme/tokens'
...
export function OrderAlertHost() {
  ...
  const hide = useCallback(() => {
    ...
    ty.value = withTiming(-160, { duration: 260, easing: Easing.bezier(...motion.easeOut) },
...
const styles = StyleSheet.create({
  ...
  btnGhostText: { color: color.ink3, fontWeight: '700', fontSize: 12.5 },
})
