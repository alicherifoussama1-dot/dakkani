      ...
      <div className="max-w-lg mx-auto text-center space-y-5 py-8">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm space-y-3">
          <div className="flex justify-between">
            ...
            <span className="font-mono font-black text-dakkani-600 text-lg">{orderNumber}</span>
          </div>
          <div className="flex justify-between">
          ...
          {deliveryDays && (
            <div className="flex justify-between">
              ...
              <span className="font-medium text-dakkani-600">{deliveryDays}</span>
            </div>
          )}
          {badge && (
        ...
        <a
          ...
          className="block w-full bg-dakkani-500 hover:bg-dakkani-600 text-white font-bold py-3 rounded-xl transition"
        >
          العودة للمتجر
        </a>
      </div>
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          {product && (
            <div className="lg:hidden bg-white rounded-2xl border border-gray-100 p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-dakkani-600 font-black">{formatDZD(unitPrice)}</p>
              </div>
            </div>
          )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
            <h2 className="font-bold text-gray-900 flex items-center gap-2">
              <span className="w-6 h-6 bg-dakkani-500 text-white rounded-full flex items-center justify-center text-xs font-black">1</span>
              معلومات العميل
            </h2>
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-dakkani-500 outline-none"
              />
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
            <h2 className="font-bold text-gray-900 flex items-center gap-2">
              <span className="w-6 h-6 bg-dakkani-500 text-white rounded-full flex items-center justify-center text-xs font-black">2</span>
              معلومات التوصيل
            </h2>
              ...
              {([
                ...
                <label
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition ${
                    watchedDeliveryType === val
                      ? 'border-dakkani-500 bg-dakkani-50'
                ...
                >
                  <input
                    ...
                    className="sr-only"
                  />
                  <Icon className={`w-5 h-5 ${watchedDeliveryType === val ? 'text-dakkani-500' : 'text-gray-400'}`} />
                  <div>
                    <p className={`text-sm font-semibold ${watchedDeliveryType === val ? 'text-dakkani-700' : 'text-gray-700'}`}>
                      {label}
                    </p>
                    {selectedWilaya && (
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:ring-2 focus:ring-dakkani-500 outline-none appearance-none"
                >
              ...
              {selectedWilaya && (
                <div className="mt-2 flex items-center gap-3 text-xs text-dakkani-600 bg-dakkani-50 px-3 py-2 rounded-lg">
            ...
            {watchedDeliveryType === 'home' && (
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-dakkani-500 outline-none resize-none"
                />
              </div>
            )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-3">
            <h2 className="font-bold text-gray-900 flex items-center gap-2">
              <span className="w-6 h-6 bg-dakkani-500 text-white rounded-full flex items-center justify-center text-xs font-black">3</span>
              طريقة الدفع
            </h2>
            ...
            {[
              ...
              >
                ...
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${
                  ...
                  {watchedPayment === opt.value && <div className="w-2.5 h-2.5 bg-dakkani-500 rounded-full" />}
                </div>
                <opt.icon className={`w-5 h-5 ${watchedPayment === opt.value ? 'text-dakkani-500' : 'text-gray-400'}`} />
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-dakkani-500 outline-none uppercase"
                onBlur={checkCoupon}
              />
              <button
                type="button"
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="lg:sticky lg:top-20 space-y-4">
              ...
              <div className="hidden lg:block bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-dakkani-600 font-black text-lg mt-1">{formatDZD(unitPrice)}</p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-2.5">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between font-black text-gray-900 text-base border-t border-gray-100 pt-2.5 mt-2">
                  <span>المجموع</span>
                  <span className="text-dakkani-600 text-xl">{formatDZD(total)}</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-dakkani-500 hover:bg-dakkani-600 disabled:opacity-60 text-white font-black py-4 rounded-2xl text-base transition flex items-center justify-center gap-2"
            >
