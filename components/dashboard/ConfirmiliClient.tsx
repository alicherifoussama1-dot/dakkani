    ...
    <div className="flex flex-col h-full" dir="rtl">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b bg-white flex-wrap gap-2" style={{borderColor:'var(--color-border)'}}>
        <div className="flex items-center gap-3">
          ...
          <span className="badge badge-yellow text-xs" style={{fontFamily:'var(--font-arabic)'}}>Bronze</span>
        </div>
        <div className="flex items-center gap-3">
          <div className="text-xs" style={{color:'var(--color-text-muted)',fontFamily:'var(--font-arabic)'}}>الرصيد: <strong style={{color:'var(--color-text-primary)'}}>0 دج</strong></div>
          <div className="text-xs" style={{color:'var(--color-text-muted)',fontFamily:'var(--font-arabic)'}}>الطلبات المتبقية: <strong style={{color:'var(--color-accent)'}}>836/1000</strong></div>
