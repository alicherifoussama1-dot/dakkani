      ...
      <div className="flex flex-wrap gap-2">
        <div className="relative">
          ...
          <input
            ...
            className="bg-gray-800 border border-gray-700 rounded-lg pr-9 pl-3 py-1.5 text-sm text-gray-300 focus:ring-1 focus:ring-[#0D6EFD] outline-none w-52"
          />
        </div>
        <select
                ...
                <tr key={p.id} className="hover:bg-gray-800/30 transition">
                  ...
                  <td className="px-4 py-3">
                    {p.use_store_pixel
                      ...
                      : hasPixel
                      ? <span className="text-xs bg-[#0D6EFD]/20 text-[#60A5FA] px-2 py-0.5 rounded border border-[#0D6EFD]/30">خاص</span>
                      : <span className="text-xs text-gray-700">—</span>
                    }
                  </td>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      <Link href={`/admin/products/${p.id}/edit`} className="p-1.5 text-gray-500 hover:text-[#60A5FA] hover:bg-[#0D6EFD]/10 rounded-lg transition">
        ...
        {totalPages > 1 && (
          <div className="border-t border-gray-800 px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              {page < totalPages && (
                <button onClick={() => push('page', String(page + 1))} className="text-xs px-3 py-1.5 bg-[#0D6EFD] text-white hover:bg-[#0B5ED7] rounded-lg">التالي</button>
              )}
            </div>
          </div>
        )}
