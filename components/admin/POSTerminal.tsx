      ...
      <div className="flex-1 flex flex-col p-4 overflow-hidden">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded-xl pr-10 pl-4 py-3 text-sm text-gray-200 focus:ring-2 focus:ring-[#0D6EFD] outline-none"
          />
        </div>
          ...
          {filteredProducts.map(p => {
            ...
            return (
              <button
                ...
                onClick={() => addToCart(p)}
                disabled={stock <= 0}
                className={`relative bg-gray-900 border rounded-2xl p-3 text-right hover:border-[#0D6EFD] transition group disabled:opacity-40 disabled:cursor-not-allowed ${
                  inCart ? 'border-[#0D6EFD] bg-[#0D6EFD]/10' : 'border-gray-800'
                }`}
              >
      ...
      <div className="w-80 bg-gray-900 border-r border-gray-800 flex flex-col">
        ...
        <div className="p-3 border-t border-gray-800">
          ...
          <div className="flex gap-2">
            ...
            <input
              ...
              placeholder="0"
              className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-3 py-1.5 text-sm text-gray-200 focus:ring-1 focus:ring-[#0D6EFD] outline-none"
            />
          </div>
        </div>
        ...
        <div className="p-3 border-t border-gray-800 space-y-3">
          ...
          <button
            ...
            className="w-full bg-[#0D6EFD] hover:bg-[#0B5ED7] disabled:opacity-40 text-white font-black py-3.5 rounded-xl text-base transition"
          >
