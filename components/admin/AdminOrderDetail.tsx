      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2 text-gray-300 font-semibold text-sm">
            <Icon className="w-4 h-4 text-dakkani-500" />
            {title}
          </div>
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className={`text-xs px-2.5 py-1 rounded-full font-bold ${
              ...
              'bg-dakkani-500/20 text-dakkani-400 border border-dakkani-500/30'
            }`}>
            ...
            <>
              {STATUS_STEPS.indexOf(status) < STATUS_STEPS.length - 1 && (
                <button
                  ...
                  disabled={!!loading}
                  className="flex items-center gap-1.5 text-xs px-3 py-2 bg-dakkani-500 text-white hover:bg-dakkani-600 rounded-lg transition disabled:opacity-50"
                >
              ...
              <div key={step} className="flex-1 flex items-center">
                <div className="flex flex-col items-center gap-1">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${
                    ...
                    i === stepIdx ? 'bg-dakkani-500 text-white ring-2 ring-dakkani-400/30' :
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300 focus:ring-1 focus:ring-dakkani-500 outline-none"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300 font-mono focus:ring-1 focus:ring-dakkani-500 outline-none"
                />
              </div>
              ...
              <div className="space-y-2 mt-2">
                {order.logs.slice(-5).reverse().map((log: any, i: number) => (
                  <div key={i} className="flex items-start gap-3 text-xs">
                    <div className="w-2 h-2 bg-dakkani-500 rounded-full mt-1 flex-shrink-0" />
                    <div>
        ...
        <div className="space-y-4">
          ...
          <Section title="نص الاتصال (AI)" icon={MessageSquare} defaultOpen={false}>
            {aiScript ? (
              ...
              <button
                ...
                disabled={loading === 'ai'}
                className="w-full py-2 text-xs bg-dakkani-500/20 text-dakkani-400 border border-dakkani-500/30 hover:bg-dakkani-500/30 rounded-lg transition disabled:opacity-50 flex items-center justify-center gap-2"
              >
          ...
          <Section title="ملاحظات داخلية" icon={FileText} defaultOpen={false}>
            <textarea
              ...
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300 focus:ring-1 focus:ring-dakkani-500 outline-none resize-none"
            />
            <button
              onClick={saveNote}
