    ...
    <aside className="w-56 bg-gray-900 border-l border-gray-800 flex flex-col">
      <div className="p-4 border-b border-gray-800">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-dakkani-500 rounded-lg flex items-center justify-center">
        ...
        {NAV.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href} className={cn(
              ...
              active ? 'bg-dakkani-500/20 text-dakkani-400' : 'text-gray-400 hover:bg-gray-800 hover:text-gray-200'
            )}>
