      ...
      <div className="w-full max-w-md space-y-5">
        ...
        {order && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="bg-dakkani-500 px-5 py-3 flex items-center justify-between">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="border-t border-gray-100 pt-3 space-y-2 text-sm">
                ...
                <div className="flex justify-between font-black text-gray-900 text-base">
                  ...
                  <span className="text-dakkani-600">{formatDZD(order.total)}</span>
                </div>
              </div>
        ...
        <a
          ...
          className="block w-full text-center bg-dakkani-500 hover:bg-dakkani-600 text-white font-bold py-3.5 rounded-2xl transition"
        >
          العودة للمتجر
        </a>
