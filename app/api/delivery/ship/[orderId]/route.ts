...
export async function POST(req: Request, { params }: { params: { orderId: string } }) {
  ...
  // Store-owned delivery log (NOT a Confirmili table).
  ...
  // NOTE: Confirmili's "تقرير الإرسال" logging lives in the Confirmili caller
  // (ConfirmiliOrders.sendToDelivery), so this store route stays free of any
  // confirmili_* table reference.
