// GET /api/store/delivery/office-list?store_id=&wilaya_id=  — SERVER-SIDE ONLY
// Fresh route path replacing the old /desks endpoint whose Vercel-built
// serverless function kept serving a stale build (commune names not normalized);
// a new path deploys clean. Identical logic; the browser calls THIS route now.
